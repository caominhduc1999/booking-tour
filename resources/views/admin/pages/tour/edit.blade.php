                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" id="">
                                        ...
                                        <option value="2" @if(old('type') ? old('type') == 2 : $tour->type == 2) selected @endif>Quốc tế</option>
                                    </select>
                                    @error('type')
                                        <div class="text-danger">
                                            {{ $message }}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="frequency" id="">
                                        <option value=""></option>
                                        <option value="1" @if(old('frequency') ? old('frequency') == 1 : $tour->frequency == 1) selected @endif>Hàng tuần</option>
