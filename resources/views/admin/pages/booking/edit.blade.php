                ...
                <form action="{{ route('bookings.update', $booking->id) }}" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="tour_id" id="">
                                ...
                                @foreach($tours as $tour)
                                    <option value="{{ $tour->id }}" @if(old('tour_id') ? old('tour_id') == $tour->id : $booking->tour_id == $tour->id) selected @endif>{{ $tour->name }}</option>
                                @endforeach
                            </select>
                            @error('tour_id')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="adult_number" id="exampleInputEmail1" placeholder="Số lượng người lớn" value="{{ old('adult_number', $booking->adult_number) }}">
                            @error('adult_number')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>    
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="children_number" id="exampleInputEmail1" placeholder="Số lượng trẻ em" value="{{ old('children_number', $booking->children_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="baby_number" id="exampleInputEmail1" placeholder="Số lượng trẻ sơ sinh" value="{{ old('baby_number', $booking->baby_number) }}">
                            @error('baby_number')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>    
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="discount_id" id="">
                                ...
                                @foreach($discounts as $discount)
                                    <option value="{{ $discount->id }}" @if(old('discount_id') ? old('discount_id') == $discount->id : $booking->discount_id == $discount->id) selected @endif>{{ $discount->code }}</option>
                                @endforeach
                            </select>
                            @error('discount_id')
                                <div class="text-danger">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="payment_status" id="">
                                ...
                                <option value="2" @if(old('payment_status') ? old('payment_status') == 1 : $booking->payment_status == 1) selected @endif>Đã thanh toán</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status" id="">
                                ...
                                <option value="2" @if(old('status') ? old('status') == 1 : $booking->status == 1) selected @endif>Đã xác nhận</option>
                            </select>
                            @error('status')
                                <div class="text-danger">
                                    {{ $message }}
